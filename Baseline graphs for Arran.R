...
# Core libraries loaded at the top of the script. Patchwork is optional for
# assembling multipanel figures—only load it if you actually need multipanel
# layouts and have it installed.
